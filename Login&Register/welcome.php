...
<body>
  ...
  <div class="container">
    ...
    <h3 class="text-center">Setup Mellow</h3>
        ...
        <table class="table table-striped table-hover table-bordered">
          ...
          ?>
            ...
            <tr>
              ...
              <td>
                <a href="welcome.php?hal=edit&id=<?= $data['id_barang'] ?>" class="btn btn-warning">Edit</a>
                <a href="welcome.php?hal=hapus&id=<?= $data['id_barang'] ?>" class="btn btn-danger" onclick="return confirm('Apakah anda Yakin akan Hapus Data ini?')">Hapus</a>
              </td>
            </tr>
